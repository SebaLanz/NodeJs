//SELECT - find
    db.products.find(); //busco todos los productos.
    db.products.find({ "id_producto": 2 }); //el valor 2 con el id_producto que estás buscando
    db.products.find({ "category": "cocina" });//oir categoría
...
//INSERT - one / many
    ...
    db.products.insertOne({
        ...
        "price": 49.99,
        "thumbnail": "/assets/img/new_product.jpg",
        "code": "NP001",
        "stock": 10,
        "status": true,
...
//Ejemplo de many, pero faltan filtros
    db.products.updateMany(
        { "category": "cocina" },
        { $set: { "price": 10.99 } }
      );
      
//ACTUALIZAR Estado true o false
    db.products.updateOne(
        { "id_producto": 32 },
        { $set: { "status": false } }//True o false
    );

//ELIMINAR Datos
    db.products.deleteOne({ "id_producto": 32 });
