...
class productoDb { 
    ...
    async insertarProductos() {
      ...
      try {
        ...
        await conec.conectar();
  
        // Insertar productos en la colección "products"
        await conec.db.collection('products').insertMany(productos);
        console.log('Productos insertados correctamente en la colección "products"');
      } catch (error) {
        console.error('Error al insertar productos:', error);
      } finally {
        // Desconectar siempre, incluso si hay un error
        await conec.desconectar();
      }
    }
  }
